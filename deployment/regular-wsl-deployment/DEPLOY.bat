@echo off
REM Regular Test Case API - Complete Windows Deployment Launcher
REM This script launches the complete regular WSL deployment

echo ================================================================
echo   🚀 Regular Test Case API - Complete Deployment Launcher
echo ================================================================
echo.
...
echo ================================================================
wsl -d Ubuntu2204 -- bash -c "cd /mnt/d/DK\$/_Projects/test_case_api/deployment/regular-wsl-deployment && chmod +x deploy-regular-wsl.sh && ./deploy-regular-wsl.sh"
